...
class PathFunctions:
    ...
    def create_folder() -> Path:
        ...
        """
        folder_path = PathFunctions.get_folder_path()  # Updated to use the class name
    ...
    def save_start_file(logfile_path:   str | Path) -> Path:
        ...
        """
        eval_start_file = PathFunctions.create_folder() / "start_eval.txt"
    ...
    def check_for_file() -> bool:
        ...
        """
        eval_start_file = PathFunctions.get_folder_path() / "start_eval.txt"
    ...
    def delete_folder() -> bool:
        ...
        """
        folder_path = PathFunctions.get_folder_path()
